    ...
    <SidebarContainer>
      ...
      <section className={styles["page-section"]}>
        <div className={styles.container}>
          ...
          <p className={styles["terms-text"]}>
            a. The Stastiem platform is a service allowing customers to review
          ...
          <p className={styles["terms-text"]}>
            a. Access to certain functionalities of the platform requires
          ...
          <p className={styles["terms-text"]}>
            a. All content on this platform, including text, graphics, logos,
            and software, is the property of Stastiem or its content suppliers
