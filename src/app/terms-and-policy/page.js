    ...
    <section className={styles["page-section"]}>
      <div className={styles.container}>
        ...
        <p className={styles["terms-text"]}>
          ...
          Conditions govern your use of our platform and services. By accessing
          or using our platform, you agree to be bound by these terms.
        </p>
        <p className={styles["terms-title"]}>2. Use of Platform</p>
        <p className={styles["terms-text"]}>
          a. The Stastiem platform is a service allowing customers to review and
          edit personalized storybook orders. <br />
          b. You agree to use this platform solely for lawful purposes, in
          compliance with all applicable laws.
        </p>
        <p className={styles["terms-title"]}>3. User Accounts</p>
        <p className={styles["terms-text"]}>
          a. Access to certain functionalities of the platform requires creating
          a user account.
        ...
        <p className={styles["terms-title"]}>4. Intellectual Property Rights</p>
        <p className={styles["terms-text"]}>
          a. All content on this platform, including text, graphics, logos, and
